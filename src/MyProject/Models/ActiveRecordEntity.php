...
abstract class ActiveRecordEntity
{
     ...
     public static function findRequiredAmount(int $numberOfArticles): array
     {
        $db = Db::getInstance();
        return $db->query('SELECT * FROM `' . static::getTableName() . '` ORDER BY id DESC LIMIT ' . $numberOfArticles . ';', [], static::class);
     }
